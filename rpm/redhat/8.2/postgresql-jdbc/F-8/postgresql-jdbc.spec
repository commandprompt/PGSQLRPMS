...
%{!?upstreamserver:%define upstreamver	8.2-510}
...
%changelog
* Thu Jul 30 2009 Devrim Gunduz <devrim@CommandPrompt.com> 0:8.2.510-1PGDG
- Update to build 510.
...
* Tue Jan 1 2008 Devrim Gunduz <devrim@CommandPrompt.com> 0:8.2.507-2PGDG
- Updated gcj_support requires, per Fedora spec file
- Fix buildroot
- Cosmetic cleanup
- Removed unused section macro

* Tue Dec 4 2007 Devrim Gunduz <devrim@CommandPrompt.com> 0:8.2.507-1PGDG
- Update to build 507
