...
%{!?upstreamserver:%define upstreamver	8.0-323}
...
%changelog
* Sat Dec 6 2008 Devrim Gunduz <devrim@CommandPrompt.com> 0:8.0.323-1PGDG
- Update to build 323

* Tue Mar 4 2008 Devrim Gunduz <devrim@CommandPrompt.com> 0:8.0.322-1PGDG
