...
Source0:	http://files.commandprompt.com/replicator/%{name}-%{version}-1.8.0.tar.bz2
...
Source100:	postgresql-README.SuSE.de
Source101:	postgresql-README.SuSE.en
...
PreReq:		mammoth-replicator-libs = %pg_minor_version
...
install -m 755 %{SOURCE3} %buildroot/etc/init.d/mammoth
ln -s ../../etc/init.d/mammoth %buildroot/usr/sbin/rcmammoth
...
cp -a %SOURCE101 %buildroot%_docdir/postgresql/README.SuSE.de
cp -a %SOURCE102 %buildroot%_docdir/postgresql/README.SuSE.en
...
%files server
%defattr(-,root,root)
%config /etc/init.d/mammoth
%config /var/adm/fillup-templates/sysconfig.mammoth
%if 0%suse_version > 1020
%config /etc/sysconfig/SuSEfirewall2.d/services/mammoth
%endif
