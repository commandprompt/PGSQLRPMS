...
Source0:	http://pgfoundry.org/frs/download.php/2284/%{name}-%{version}.tgz
Source1:	%{name}.init
...
%changelog
* Thu Dec 10 2009 Devrim GUNDUZ <devrim@CommandPrompt.com> - 1.3.1-4
- Adjust order of startup and kill.

* Sat Dec 05 2009 Devrim GUNDUZ <devrim@CommandPrompt.com> - 1.3.1-3
